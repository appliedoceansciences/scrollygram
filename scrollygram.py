...
def main():
    ...
    pth = threading.Thread(target=child_thread, args=(main_thread_work, (df_desired, dt_desired, f0_desired, fh_desired, yield_acoustic_packets, (yield_packet_bytes_function, input_source, phonemask))))
    pth.start()
